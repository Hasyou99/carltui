<template>
    <div class="c-tooltip" @mouseenter="_mouseEnter" @mouseleave="_mouseLeave" ref="toolDiv">
        <slot/>
    ...
    export default {
        ...
        methods: {
            ...
            _createElement(){
                ...
                //取当前标签偏移位置
                let offset = utils.getOffset(this.$refs.toolDiv);
                let windowWidth = utils.getWidth(window);
